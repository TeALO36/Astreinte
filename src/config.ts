...
const ENV_OVERRIDES: Record<string, string> = {
  ...
  "transport.telegram_auth": "SNAP_ASTREINTE_TELEGRAM_AUTH_TYPE",
  "transport.telegram_bot_token": "SNAP_ASTREINTE_TELEGRAM_BOT_TOKEN",
  "image.api_key": "SNAP_ASTREINTE_IMAGE_API_KEY",
